...
- [x] Pilot Operator Runbook V1 so Data Health connects share gate, source gate, provider setup, one-provider smoke, validate/preview, packet, and hygiene without reopening broad proof loops.
