...
LOCAL_DATASET_SCHEMAS: dict[str, LocalDatasetSchema] = {
    "prices": LocalDatasetSchema(
        ...
        optional_columns=("adj_close", "adjusted_close", "close", "open", "high", "low", "volume", "currency", "source", "as_of_date", "notes"),
    ...
    "peer_candidates": LocalDatasetSchema(
        dataset_name="peer_candidates",
        required_columns=("ticker", "peer_ticker", "candidate_state"),
        optional_columns=(
            "peer_group",
            "sector",
            "industry",
        ...
        date_columns=("as_of_date", "review_date"),
        ticker_columns=("ticker", "peer_ticker"),
    ),
