...
class StockReport:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        provenance = {
            ...
            "financial_currency": self.financial_summary.get("currency"),
            "price_currency": self.price_snapshot.get("currency"),
...
def build_stock_report_markdown(report: StockReport, local_context: dict[str, Any] | None = None) -> str:
    ...
    report_lines = [
        ...
        *_stock_report_review_metric_lines(payload.get("review_metrics", {})),
        ...
        f"- Financial currency: {_display_value(provenance.get('financial_currency'))}",
        f"- Price currency: {_display_value(provenance.get('price_currency'))}",
