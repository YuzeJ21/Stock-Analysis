...
def main() -> None:
    ...
    parser.add_argument("--write-import", action="store_true", help="Write a universe import file to data/imports/universe.csv.")
    parser.add_argument("--apply-import", action="store_true", help="Apply the universe import file to data/universe.csv with backup.")
