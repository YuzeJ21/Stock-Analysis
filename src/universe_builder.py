...
def main() -> None:
    ...
    parser.add_argument("--write-import", action="store_true", help="Write a staged universe import to data/imports/universe.csv.")
    parser.add_argument("--apply-import", action="store_true", help="Apply the staged universe import to data/universe.csv with backup.")
    ...
    parser.add_argument("--overwrite", action="store_true", help="Overwrite an existing staged universe import file.")
