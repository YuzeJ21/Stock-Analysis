    ...
    *,
    ...
    lines.extend(
        [
            ...
            "- make optional-context-source-ladder TICKERS=<resolved-tickers>",
            "- make templates only when trusted provider/manual rows are unavailable or you need schema files",
            "- make import-earnings or make import-analyst-estimates only after trusted staged files exist",
