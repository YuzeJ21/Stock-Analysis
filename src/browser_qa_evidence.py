...
DEFAULT_BROWSER_QA_ROUTE_CHECKS: tuple[BrowserQaRouteCheck, ...] = (
    ...
    BrowserQaRouteCheck(
        ...
        details_boundary="Decision Lab identity, Forward View evidence, quarterly evidence, source rows, and technical diagnostics stay collapsed under Advanced.",
...
DEFAULT_BROWSER_QA_RESPONSIVE_ROUTE_CHECKS: tuple[BrowserQaResponsiveRouteCheck, ...] = (
    ...
    BrowserQaResponsiveRouteCheck(
        ...
        desktop_viewport="1280x720",
        phone_viewport="390x844",
        first_view_must_keep="Saved readiness, Company Workbench, usable evidence, withheld lanes, one Data Health handoff, Research Decision Lab, stop condition",
