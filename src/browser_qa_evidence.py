...
DEFAULT_BROWSER_QA_ROUTE_CHECKS: tuple[BrowserQaRouteCheck, ...] = (
    ...
    BrowserQaRouteCheck(
        ...
        route="http://localhost:8501/?mode=operator&page=data-health&lane=metrics&drawer=metrics",
        first_view_markers=("research-loop-strip", "ops-mode-strip", "Selected Lane Answer", "Metrics", "Data Health Workspace"),
...
DEFAULT_BROWSER_QA_RESPONSIVE_ROUTE_CHECKS: tuple[BrowserQaResponsiveRouteCheck, ...] = (
    BrowserQaResponsiveRouteCheck(
        ...
        first_view_must_keep="You are here, Current question, Primary next step, Stop rule, What can I use now?, First 30 Seconds",
    ...
    BrowserQaResponsiveRouteCheck(
        ...
        desktop_viewport="1280x720",
        phone_viewport="390x844",
        first_view_must_keep="You are here, Stock Selector, Which stock can I review?, filter/selection state, one next action",
    ...
    BrowserQaResponsiveRouteCheck(
        ...
        desktop_viewport="1280x720",
        phone_viewport="390x844",
        first_view_must_keep="You are here, One-Stock Review, What Can Be Read Now, selected ticker, blocked inputs, one next action",
    ...
    BrowserQaResponsiveRouteCheck(
        ...
        desktop_viewport="1280x720",
        phone_viewport="390x844",
        first_view_must_keep="You are here, Coverage Summary / What Can I Use?, one lane answer, Proof Map, Advanced collapsed",
    ...
    BrowserQaResponsiveRouteCheck(
        ...
        desktop_viewport="1280x720",
        phone_viewport="390x844",
        first_view_must_keep="You are here, Evidence-only page, one proof answer, latest proof evidence collapsed, raw ledger details collapsed",
