...
DEFAULT_BROWSER_QA_EVIDENCE: tuple[BrowserQaEvidence, ...] = (
    ...
    BrowserQaEvidence(
        ...
        expected_markers=("research-loop-strip", "ops-mode-strip", "Selected Lane Answer", "Metrics", "Data Health Workspace"),
        min_width=1000,
        min_height=600,
...
DEFAULT_BROWSER_QA_ROUTE_CHECKS: tuple[BrowserQaRouteCheck, ...] = (
    ...
    BrowserQaRouteCheck(
        ...
        details_boundary="Stock Selector starts with a direct review-queue search and optional filters; raw readiness tables, methodology, and operator details stay out of the first public view.",
    ...
    BrowserQaRouteCheck(
        ...
        first_view_markers=("Selected Lane Answer", "Prices", "Data Health Workspace", "READINESS CONTEXT"),
    ...
    BrowserQaRouteCheck(
        ...
        route="http://localhost:8501/?mode=operator&page=data-health&lane=metrics&drawer=metrics",
        first_view_markers=("Selected Lane Answer", "Metrics", "Data Health Workspace"),
        details_boundary="Metric evidence stays readiness-gated; advanced details appear only after the metrics review route is selected.",
    ...
    BrowserQaRouteCheck(
        ...
        route="http://localhost:8501/?mode=operator&page=data-health&lane=proof",
        first_view_markers=("Selected Lane Answer", "Proof History"),
    ...
    BrowserQaRouteCheck(
        ...
        first_view_markers=("Proof History", "proof-record"),
    ...
    BrowserQaRouteCheck(
        ...
        route="http://localhost:8501/?mode=operator&page=data-health&lane=fundamentals&drawer=queue",
        first_view_markers=("Selected Lane Answer", "Fundamentals / DCF", "SOURCE GATE"),
    ...
    BrowserQaRouteCheck(
        ...
        first_view_markers=("Saved readiness", "Company Workbench", "Use now", "Still withheld", "Open Data Health", "Research Decision Lab", "Research-only"),
        details_boundary="The `Add a reviewed research record` composer stays below the selected-company and journal/outcome answers; Advanced evidence remains collapsed.",
        ...
        stop_rule="Stop if the workbench shows traceback text, synthetic evidence as real, an unavailable forecast, an Arrow-incompatible evidence table, a visible confirmation appears before an exact preview, or a route-marker screenshot is presented as validation, confirmation, or persistence evidence.",
    ),
    BrowserQaRouteCheck(
...
DEFAULT_BROWSER_QA_RESPONSIVE_ROUTE_CHECKS: tuple[BrowserQaResponsiveRouteCheck, ...] = (
    BrowserQaResponsiveRouteCheck(
        ...
        first_view_must_keep="Saved readiness, Step 1 of 5, page question, Research-only, Start with Stock Selector, No data, no conclusion",
    ...
    BrowserQaResponsiveRouteCheck(
        ...
        desktop_viewport="1280x720",
        phone_viewport="390x844",
        first_view_must_keep="Saved readiness, Step 2 of 5, Stock Selector, Which stock can I review?, review-queue search, compact results",
    ...
    BrowserQaResponsiveRouteCheck(
        ...
        desktop_viewport="1280x720",
        phone_viewport="390x844",
        first_view_must_keep="Saved readiness, Step 3 of 5, selected ticker, Use now, Still withheld, one Data Health handoff",
    ...
    BrowserQaResponsiveRouteCheck(
        ...
        desktop_viewport="1280x720",
        phone_viewport="390x844",
        first_view_must_keep="Saved readiness, Step 4 of 5, lane coverage summary, four lane answers, Advanced collapsed",
    ...
    BrowserQaResponsiveRouteCheck(
        ...
        desktop_viewport="1280x720",
        phone_viewport="390x844",
        first_view_must_keep="Saved readiness, Company Workbench, usable evidence, withheld lanes, one Data Health handoff, Research Decision Lab, Research-only",
        mobile_risk="Long review-path copy, the below-answer composer, or technical sections obscure the selected-company answer and research boundary.",
        stop_rule="Stop if the phone view overflows, shows traceback text, renders technical evidence before the selected-company answer, or shows a visible confirmation before an exact preview.",
    ),
    BrowserQaResponsiveRouteCheck(
        page="Monitor",
        route="http://localhost:8501/?mode=research&page=monitor",
