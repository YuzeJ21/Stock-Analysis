...
DEFAULT_BROWSER_QA_ROUTE_CHECKS: tuple[BrowserQaRouteCheck, ...] = (
    ...
    BrowserQaRouteCheck(
        ...
        first_view_markers=("Saved readiness", "Company Workbench", "Use now", "Still withheld", "Open Data Health", "Research-only"),
...
DEFAULT_BROWSER_QA_RESPONSIVE_ROUTE_CHECKS: tuple[BrowserQaResponsiveRouteCheck, ...] = (
    ...
    BrowserQaResponsiveRouteCheck(
        ...
        desktop_viewport="1280x720",
        phone_viewport="390x844",
        first_view_must_keep="Saved readiness, Company Workbench, usable evidence, withheld lanes, one Data Health handoff, stop condition",
