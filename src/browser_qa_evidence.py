...
DEFAULT_BROWSER_QA_ROUTE_CHECKS: tuple[BrowserQaRouteCheck, ...] = (
    ...
    BrowserQaRouteCheck(
        ...
        first_view_markers=(
            ...
            "Research-only",
            "Evidence-only page",
            "What is Proof History for?",
            "Advanced: latest proof evidence",
            "Advanced: proof ledger details",
        ),
        details_boundary="Proof History starts with one evidence answer; latest proof cards and raw ledger rows stay collapsed under advanced proof details.",
...
DEFAULT_BROWSER_QA_RESPONSIVE_ROUTE_CHECKS: tuple[BrowserQaResponsiveRouteCheck, ...] = (
    BrowserQaResponsiveRouteCheck(
        ...
        first_view_must_keep="Saved readiness, Step 1 of 5, page question, Research-only, Start with Stock Selector, First 30 Seconds",
    ...
    BrowserQaResponsiveRouteCheck(
        ...
        desktop_viewport="1280x720",
        phone_viewport="390x844",
        first_view_must_keep="Saved readiness, Step 2 of 5, Stock Selector, Which stock can I review?, selected ticker, one next action",
    ...
    BrowserQaResponsiveRouteCheck(
        ...
        desktop_viewport="1280x720",
        phone_viewport="390x844",
        first_view_must_keep="Saved readiness, Step 3 of 5, One-Stock Review, What Can Be Read Now, blocked/context, one next action",
    ...
    BrowserQaResponsiveRouteCheck(
        ...
        desktop_viewport="1280x720",
        phone_viewport="390x844",
        first_view_must_keep="Saved readiness, Step 4 of 5, Coverage Summary / What Can I Use?, four lane answers, Advanced collapsed",
    ...
    BrowserQaResponsiveRouteCheck(
        ...
        desktop_viewport="1280x720",
        phone_viewport="390x844",
        first_view_must_keep="Saved readiness, Step 5 of 5, Evidence-only page, one proof answer, latest proof evidence collapsed, raw ledger details collapsed",
