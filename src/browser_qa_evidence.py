...
DEFAULT_BROWSER_QA_ROUTE_CHECKS: tuple[BrowserQaRouteCheck, ...] = (
    ...
    BrowserQaRouteCheck(
        ...
        details_boundary="Stock Selector starts with a starting-ticker handoff and filters; raw readiness tables, methodology, and operator details stay out of the first public view.",
...
DEFAULT_BROWSER_QA_RESPONSIVE_ROUTE_CHECKS: tuple[BrowserQaResponsiveRouteCheck, ...] = (
    ...
    BrowserQaResponsiveRouteCheck(
        ...
        desktop_viewport="1280x720",
        phone_viewport="390x844",
        first_view_must_keep="Saved readiness, Step 2 of 5, Stock Selector, Which stock can I review?, starting ticker, one next action",
