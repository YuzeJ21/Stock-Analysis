    ...
    *,
    ...
    rows = [
        ...
        },
        {
            ...
            "Answer": (
                "Release gate rows, proof queues, provider setup details, packet commands, and generated-artifact "
                "lists stay in review drawers until a reviewer opens them."
            ),
        ...
        },
        {
            ...
            "Answer": (
                "New source-backed rows, one configured keyed free-tier provider, reviewed manual rows, "
                "or changed blockers can reopen a narrow source-proof slice."
            ),
            "Share Boundary": (
                "Provider setup is not data proof; use one reviewed ticker smoke path before validate, "
                "preview, apply, or proof recording."
            ),
        ...
        },
        {
            ...
            "Answer": (
                "Run the capped universe preview summary first; review SMH/S&P source warnings and row counts "
                "before any universe-stage or universe-apply step."
            ),
            "Share Boundary": (
                "Universe membership is metadata only; fallback holdings sources do not unlock fundamentals, "
                "share count, DCF, peers, earnings, estimates, or recommendations."
            ),
    ...
    *,
    ...
    rows = [
        ...
        },
        {
            ...
            "Purpose": f"Open the leading source-proof lane evidence drawer: {proof_title}. Route links do not execute commands.",
            "Primary View": "Selected lane evidence drawer",
            "Next Safe Action": proof_command,
