...
PUBLIC_ROUTES = [
    (
        ...
        "You are here, Current question, Primary next step, Stop rule, First 30 Seconds, Primary Workflow",
    ...
    (
        ...
        "You are here, Current question, Primary next step, Stop rule, selected ticker handoff, readiness-backed rows",
    ...
    (
        ...
        "You are here, Current question, Primary next step, Stop rule, selected ticker, usable now, blocked inputs",
