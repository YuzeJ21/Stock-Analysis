...
PUBLIC_ROUTES = [
    (
        ...
        "Readiness-first header, current question, Start with Stock Selector, No data, no conclusion, Advanced details collapsed",
    ...
    (
        ...
        "Readiness-first header, current question, selected ticker, Use now, Still withheld, one Data Health handoff",
    ...
    (
        ...
        "Readiness-first header, current question, one lane answer, blocked/candidate/excluded states, Advanced details collapsed",
    ...
    (
        ...
        "Readiness-first header, current question, latest evidence, one proof answer, raw ledger details collapsed",
...
DESKTOP_AND_MOBILE_RULES = [
    ...
    "Confirm the first viewport has where the visitor is, one question, one short answer, one primary next action, and one stop rule.",
