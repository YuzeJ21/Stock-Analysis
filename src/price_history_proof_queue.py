    ...
    *,
    ...
    if len(rows) == 1:
        ...
        if "reviewed proof ledger already records" in row.source_note.lower():
            ...
            lines.append(f"- Targeted provider history check: {targeted_history_command} after make readiness-snapshot PROFILE={resolve_readiness_proof_profile()}.")
