...
- One-company pilot packet: `make trusted-data-pilot-packet TICKER=META` is read-only; use it to see the trusted-data proof path and stop if source evidence is unavailable.
