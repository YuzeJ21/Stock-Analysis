...
## Source / Freshness
- local:prices.csv: research-grade / local; freshness: daily CSV through 2026-03-14; Saved local research data.
- local:fundamentals.csv: research-grade / local; freshness: local CSV through 2026-04-01; Local fundamentals data.
...
- Price freshness: `make focus-price TICKER=QQQ`.
...
- Optional context queue: `make optional-context-worklist TICKERS=QQQ TOP_N=10`.
