...
## Source Readiness
- local:prices.csv: research-grade / local; freshness: daily CSV through 2026-06-05; Saved local research data.
...
- Price freshness: `make focus-price TICKER=APLD`.
