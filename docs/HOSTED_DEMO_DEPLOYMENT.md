...
Set `STOCK_RESEARCH_DATA_PROFILE=demo` in the host environment. The public deployment must use the compact tracked profile and must not mount the ignored local refresh workspace.
