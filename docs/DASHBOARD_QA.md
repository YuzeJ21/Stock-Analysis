...
This historical pre-fix matrix was recorded on 2026-08-01: commits `b10ebcfbd`, `923fa850e`, `9ce1a6ce4`, `84562a7f6`, and `8218af401` passed the 101-test HTML-browser matrix, while the six modal-passive reproductions were withheld. It is not current-head evidence. The current branch requires a fresh exact-head local matrix, branch/PR synchronization, and exact-head CI before review-safety claims. This remains automated engineering evidence only and does not establish human or screen-reader accessibility.
