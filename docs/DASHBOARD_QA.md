...
- Single-Stock Report: confirmed a local `NVDA` preview renders `At A Glance`, `Reader Guide`, `Evaluation Snapshot`, `Proof Checklist`, then `Best Review Path` before detailed tabs.
