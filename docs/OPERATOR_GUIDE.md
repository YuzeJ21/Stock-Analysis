...
Codex plugins or skills, including Public Equity Investing and Investment Banking, are development aids only. They are not runtime dependencies, runtime decision engines, recommendation engines, stock-analysis engines, or broker integrations.
