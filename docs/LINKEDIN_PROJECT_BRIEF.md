...
- Open `outputs/stock_reports/nvda.md` to show a company report with At A Glance status, method cue, DCF assumptions, DCF formula path, Analysis Quality notes, Methodology, Evaluation Function Check, and Copyable Unlock Commands.
...
- Point to `docs/METHODOLOGY.md` when someone asks how the analysis is calculated, and to `docs/analysis_capability_audit.md` when someone asks what is strong or intentionally limited today.
