...
- A one-company evidence packet: baseline readiness, before report, focused blocker check, lane review path, operator decision, evidence expectation, validate/preview/apply, rebuild proof, and still-blocked evidence row.
