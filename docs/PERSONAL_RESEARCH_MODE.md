...
Company Workbench arbitrates one overall next task. An unresolved source-backed change wins; otherwise the existing ordered Research Conclusion priority supplies the task. Forward View guidance stays lane-specific and does not compete for the overall task. This presentation leaves readiness and evidence states independent and unchanged.
