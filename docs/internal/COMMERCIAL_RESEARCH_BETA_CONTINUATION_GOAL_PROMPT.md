...
- Field-specific focused-cohort saved-row review: margins, free cash flow, cash, debt, shares, filing dates, earnings dates, populated Revenue/EPS consensus, and every trusted-peer row keep technical availability, provenance, exact-source rights, and literal registered scope independent. Cash/debt and Revenue/EPS consensus cannot borrow sibling permission; candidate peers remain context-only and blockers stay under Advanced. Adjusted-price readiness and canonical quarterly Revenue/EPS remain open Priority 2 audit lanes.
...
- Cohort saved-row scope passage is display eligibility for one exact saved lane only. It cannot validate the payload, approve a source, change readiness, activate consensus, establish quarterly actual integrity, promote a peer role, or grant another lane. Adjusted-price readiness and canonical quarterly Revenue/EPS still require independent enforcement.
