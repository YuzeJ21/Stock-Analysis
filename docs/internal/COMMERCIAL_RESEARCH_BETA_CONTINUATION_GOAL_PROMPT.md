...
- Current verified synchronization anchor: `d2d58f90590f7dfb43f75b01c0213d15d0c19699` or a later verified descendant; exact-head GitHub Actions run `30235442248` passed and the local full suite reported 4,211 passing tests. Reverify all three before reliance.
