...
- Personal Research Mode with Research Desk -> Discover -> Company Workbench -> Monitor. Discover includes a read-only Daily Momentum & Valuation Research Queue using the approved strict momentum, own-history valuation, and fundamental-safeguard intersection. It is alphabetical, not ranked; writes no artifacts; and withholds every row missing current observation, provenance, exact-source rights, field scope, valuation history, or a required finite input.
