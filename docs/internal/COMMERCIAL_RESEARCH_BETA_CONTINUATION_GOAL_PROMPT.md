...
- Preserve the 2026-07-27 target-size correction: direct Workbench audit measured the framework help target at `16x16` and dataframe toolbar buttons at `22x22`; shared styling now reserves `24x24`, and desktop/phone retest measured every inspected visible target at `24x24` without phone document overflow. This closes only the inspected P01 defect, not full P02, keyboard, zoom, forced-colors, screen-reader, or WCAG evidence.
