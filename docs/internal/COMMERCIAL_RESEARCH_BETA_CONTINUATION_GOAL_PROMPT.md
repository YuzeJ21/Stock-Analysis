...
- Public mobile workflow audit: fresh desktop and `390x844` phone review passed for Stock Selector, Data Health, and Proof History; Home and Single-Stock Report are `blocked_with_evidence` on complete stop-rule visibility. The Single-Stock Report direct-open loading state still renders the compact selected-ticker answer before provider and report work, preserving Selected ticker -> `Use now` -> `Still withheld` -> `Open Data Health`. A 2026-08-08 zero-scroll differential recapture supersedes the earlier claim that the phone-only spacing implementation at `34b08ea867316ae3683a9a769d1ed37bd62d61ce` completed the first-viewport gate. The archived evidence tree `60492ffa5475fc00cebbc2d4c2dff0c2b140c467` and audited product head `2e58e00bb6ddff6791299a514b562c96ce911196` render identically at `390x844` with every inspected scroll offset at zero: `stop_top=854.34375`, `stop_bottom=886.3125`, `stop_clearance=-42.3125`, `action_height=44`, `action_clearance=35.9375`, and `scroll_width=390`, with no horizontal overflow or traceback. The earlier `stop_bottom=843.4296875` measurement did not record scroll position and is not top-of-page completion evidence. The existing phone spacing rules remain present; no later tracked product change caused the failure. Home separately keeps its complete stop rule below first view because metrics remain between the action and boundary in mobile DOM order. Both responsive changes require explicit owner approval before product, test, specification, commit, or push work. This is local product-layout evidence only—not hosted, accessibility-conformance, external-reviewer, freshness, demand, or market evidence—and changes no readiness, source, research, or generated-artifact state; quant state also remains unchanged.
