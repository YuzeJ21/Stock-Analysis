...
- Continue with the named open findings: a stable route-level `main` landmark, direct skip-link focus/transfer behavior, small framework controls, dynamic announcements, complete keyboard order, zoom/reflow, forced colors, and screen-reader tasks.
