...
- Public UX status is `review_limited` until `make public-performance-gate` records repeated cold/warm evidence and external reviewers complete the controlled workflow tasks.
