...
- `Overview`: quick metrics for universe size, holdings count, output coverage, missing-data warnings, local fundamentals coverage, DCF-ready count, peer-ready count, research-health readiness, a holdings-first unlock board for blocked portfolio names, and a theme-first unlock board for grouped research priorities
