...
help-full:
	...
	@echo "  make readiness-snapshot PROFILE=<default|demo|local> Write one profile-specific prior snapshot from in-memory readiness"
	...
	@echo "  CONFIRM_MATERIALIZE=1 make readiness-materialize PROFILE=<default|demo|local> Write one ignored full readiness package"
	@echo ""
	@echo "Price fallback:"
