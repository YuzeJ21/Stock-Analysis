...
demo:
	...
	@echo "   make dashboard"
	@echo ""
	@echo "3. Generate readable sample reports:"
	@echo "   make stock-report-md TICKER=NVDA"
...
trusted-data-pilot:
	...
	@echo "Evidence bundle: keep the before/after readiness count, one regenerated Markdown report, and the exact review, validate/apply, and proof commands that changed the state."
	...
	@echo "Pilot evidence packet: baseline readiness, before report, focused blocker check, lane review path, validate/preview/apply, rebuild proof, and still-blocked evidence row."
	...
	@echo "   make focus-fundamentals TICKER=<ticker>  # fundamentals lane"
	@echo "   make focus-peers TICKER=<ticker>         # peer lane"
	@echo "   make imports-validate && make imports-preview && make imports-apply"
	@echo "   make readiness && make dcf-readiness                 # fundamentals lane proof"
	@echo "   make readiness && make peer-mapping-queue TOP_N=25   # peer lane proof"
	@echo "   make stock-report-md TICKER=<ticker>"
	@echo ""
	...
	@echo "   If SEC staging is not configured or source rows are not ready, stop at diagnostics and keep the ticker data-blocked."
	@echo ""
	...
	@echo ""
	@echo "7. Prove the unlock before reading valuation:"
	@echo "   make readiness"
