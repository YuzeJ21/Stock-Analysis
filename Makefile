...
help:
	...
	@echo "  make trusted-data-pilot-packet TICKER=CRDO Print one company's read-only before/focus/validate/prove evidence packet"
...
trusted-data-pilot:
	...
	@echo "Pilot evidence packet: baseline readiness, before report, focused fundamentals check, focused peer check, import validation path, after readiness, after report."
