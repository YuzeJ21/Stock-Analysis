...
demo:
	...
	@echo "   Home readiness snapshot -> Stock Selector -> Single-Stock Report -> Data Health source-proof lane -> Proof History"
...
universe-preview-summary:
	python3 -m src.universe_builder --preview --preset sp500_smh --max-tickers 50 --summary-json
