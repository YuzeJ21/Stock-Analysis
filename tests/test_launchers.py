...
def test_readme_public_landing_page_is_short_visual_and_command_focused():
    ...
    for phrase in (
        ...
        "Development plugins or assistant skills are not shipped product dependencies",
...
def test_operator_guide_is_command_focused_and_research_only():
    ...
    for phrase in (
        ...
        "Development plugins or assistant skills are helpers only",
...
def test_analysis_capability_audit_is_public_and_data_honest():
    ...
    for phrase in (
        ...
        "Development-side plugins or assistant skills",
        "Public Equity Investing and Investment Banking plugins are not listed in `pyproject.toml`",
        "helper context only",
        "not shipped analysis rules",
        "recommendation logic",
