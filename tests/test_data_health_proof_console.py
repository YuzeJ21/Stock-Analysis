        ...
        [
            {
                ...
                "Allowed Outcome": (
                    "still_blocked"
                    if ready
                    else "auto_supported|human_reviewed_supported|candidate_context_only|still_blocked|skipped|excluded"
                ),
            }
        ]
    )
...
def test_proof_console_summary_and_loop_cards_are_research_only():
    ...
    assert "auto_supported, human_reviewed_supported, candidate_context_only, still_blocked, skipped, or excluded" in rendered
